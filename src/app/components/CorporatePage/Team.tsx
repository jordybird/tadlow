      ...
      <div className="max-w-7xl mx-auto px-0 sm:px-0 lg:px-0">
        <div className="grid md:grid-cols-12 gap-2 md:gap-16 items-start">
          ...
          <div className="md:col-span-7">
            ...
            We believe that strong teams are built through experiences. We'll help you create impactful and inspiring team-building events that strengthen bonds, build morale, and foster collaboration, creating a more cohesive and engaged workforce that can grow together.
            </p>
