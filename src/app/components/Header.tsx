      ...
      >
        ...
        >
          ...
          <nav className="space-y-8">
            <a href="#" className="block text-2xl font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">Corporate Marketing</a>
            <a href="#" className="block text-2xl font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">Sports Marketing</a>
            <a href="#" className="block text-2xl font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">Field Marketing</a>
            <a href="#" className="block text-2xl font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">Brand Developement</a>
